...
const current_users = ["Jaweria", "Ehsan Ullah", "Bilal", "Sabahat", "Meer"];
...
const new_users = ["Naseem", "JAweria", "Bilal", "Atiq", "Ayesha"];
...
const favorite_pizza = ["Fajita", "Tikka", "Butter Chicken"];
