...
// ///////////////////////////// title case ??????????????
// Q4
let quote = "Vision without power does bring moral elevation but cannot give a lasting culture.";
console.log(`Allama Muhammad Iqbal once said, "${quote}"`);
// Q5
let author = "Allama Muhammad Iqbal";
let quote2 = "Vision without power does bring moral elevation but cannot give a lasting culture.";
let message = `${author} once said, "${quote2}"`;
console.log(message);
// Q6 
